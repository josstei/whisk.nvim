...
describe('config/defaults', function()
  ...
  it('has cursor configuration', function()
    ...
    assert.equals(defaults.config.cursor.duration, 250)
  ...
  it('has scroll configuration', function()
    ...
    assert.equals(defaults.config.scroll.duration, 400)
    assert.equals(defaults.config.scroll.easing, 'ease-out')
  ...
  it('has keymaps configuration', function()
    ...
    assert.equals(defaults.config.keymaps.experimental, false)
  end)
  ...
  it('has performance configuration', function()
    ...
    assert.equals(defaults.config.performance.frame_rate_threshold, 30)
  ...
  it('all values are of correct types', function()
    ...
    assert.is_type(defaults.config.keymaps.experimental, 'boolean')
